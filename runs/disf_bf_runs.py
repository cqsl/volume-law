...
for i in range(n_Ns):
    ...
    for j in range(len(seeds)):
        ...
        for k in range(n_alphas):
            ...
            filename = os.path.join(folder, f"disf_bf_bestloss_N{N}_seed{seed}_alpha{alpha}.out")
            ...
            if not (key in best_losses):
                ...
                with open(os.path.join(folder, f"disf_bf_bestvar_N{N}_seed{seed}_alpha{alpha}.mpack"), "wb") as file:
